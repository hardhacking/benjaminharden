...
const projects = [
  ...
  },
  {
    name: 'SGI',
    description:
      'Managed Risk Approach Investing. Each day we dedicate ourselves to creating customized investment solutions and strategies for our clients.',
    link: { href: 'https://sgiam.com', label: 'sgiam.com' },
    logo: logoSummit,
  },
  {
    name: 'North Capital',
    description:
      "TransactAPI, PPEX, and many other fantastic financial API's",
    link: { href: 'https://northcapital.com', label: 'northcapital.com' },
...
export default function Projects() {
  return (
    <>
      <Head>
        <title>Projects - Benjamin Harden</title>
        <meta
          name="description"
